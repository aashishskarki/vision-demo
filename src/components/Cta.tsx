  ...
  return (
    <section className="mt-12 rounded-2xl border border-slate-200 bg-slate-900 p-6 text-white sm:p-8">
      ...
      <p className="mt-2 max-w-2xl text-sm text-slate-300">
        This was a 3-prompt demo. I can set this up for your brand at full scale — as many prompts,
        competitors, and engines as you like, tracked over time. Let&rsquo;s talk.
      </p>
      ...
      {open && (
        ...
        >
          <div
            className="w-full max-w-sm rounded-2xl bg-white p-6 text-slate-900"
            ...
            {done ? (
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  I&rsquo;ve got your details and will reach out shortly.
                </p>
                <button
              ...
              <form onSubmit={submit}>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Leave your number and I&rsquo;ll reach out about a full setup.
                </p>
